local _0_0 = nil
do
  local name_0_ = "nvim-tetris.aniseed.env"
  local module_0_ = nil
  do
...
local _2amodule_name_2a = "nvim-tetris.aniseed.env"
  ...
  do
    ...
    local function init0(opts)
      ...
      if ((false ~= opts0.compile) or os.getenv("ANISEED_ENV_COMPILE")) then
        local compile = require("nvim-tetris.aniseed.compile")
        local fennel = require("nvim-tetris.aniseed.fennel")
